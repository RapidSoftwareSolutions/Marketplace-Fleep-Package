...
$app->post('/api/Fleep/removeContactFromConversation', function ($request, $response) {
    ...
    $optionalParams = ['contactId'=>'contact_id'];
    $bodyParams = [
    ...
    $query_str = "https://fleep.io/api/contact/unlist";
