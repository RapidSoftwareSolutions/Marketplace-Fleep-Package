...
$app->post('/api/Fleep/markConversationAsRead', function ($request, $response) {
    ...
    $query_str = "https://fleep.io/api/conversation/mark_read/{$data['conversation_id']}";
