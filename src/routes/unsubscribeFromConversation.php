...
$app->post('/api/Fleep/unsubscribeFromConversation', function ($request, $response) {
    ...
    $bodyParams = [
       'json' => ['ticket','from_message_nr','email']
    ];
    ...
    $query_str = "https://fleep.io/api/conversation/unsubscribe/{$data['conversation_id']}";
