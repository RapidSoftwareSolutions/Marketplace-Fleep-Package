...
$app->post('/api/Fleep/synchronizeAllContact', function ($request, $response) {
    ...
    $optionalParams = ['searchString'=>'search_str','ignoreIds'=>'ignore'];
    $bodyParams = [
       'json' => ['ticket','search_str','ignore']
    ];
