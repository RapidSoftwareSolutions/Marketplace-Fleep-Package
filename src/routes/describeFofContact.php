...
$app->post('/api/Fleep/describeFofContact', function ($request, $response) {
    ...
    $optionalParams = ['contactName'=>'contact_name','phoneNumber'=>'phone_nr'];
    $bodyParams = [
       'json' => ['ticket','contact_id','contact_name','phone_nr']
    ];
    ...
    $query_str = "https://fleep.io/api/contact/describe";
